...
const ManageRepair = () => {
    ...
    const fetchRepairs = async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/maintenance/repairs`);
    ...
    const saveEdit = async () => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BASE_URL}/api/maintenance/repairs/${editRepair._id}`, updatedData);
    ...
    const deleteRepair = async (id) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_BASE_URL}/api/maintenance/repairs/${id}`);
